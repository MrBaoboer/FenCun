...
| Have a feature idea | Check alignment with the product's scope first, then open a [Feature request](https://github.com/MrBaoboer/FenCun/issues/new?template=feature_request.yml) |
