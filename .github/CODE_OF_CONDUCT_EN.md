...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact the maintainer privately via the email published on [@MrBaoboer](https://github.com/MrBaoboer)'s GitHub profile. This project is maintained by one person; "Community Moderators" below refers to that maintainer.
